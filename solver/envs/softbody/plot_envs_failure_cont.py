...
def main(**kwargs):
    ...
    trainer = Trainer.parse(
        ...
        rpg=dict(
            ...
            weight=dict(reward=1000.0 * T, ent_a=1. *T, ent_z=10., mutual_info=1.) # dwongrade the gradient
        ),
        # backbone=dict(TYPE='PointNet'),
        increasing_reward = 1,

        z_dim=0, z_cont_dim=3,
        #batch_size=8,
        batch_size=500,
        n_batches=50,
        #max_epochs=30,
...
main(max_epochs=200, rpg=dict(weight=dict(reward=1.)))